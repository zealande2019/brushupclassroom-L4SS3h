...
namespace ClassRoom
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Studerende e1 = new Studerende("Lasse", 13, 28);
            Studerende e2 = new Studerende("Jacob", 8, 18);
            Studerende e3 = new Studerende("Simon", 9, 24);
            Studerende e4 = new Studerende("Anders", 10, 4);
